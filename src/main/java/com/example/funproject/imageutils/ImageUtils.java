...
public class ImageUtils {
    ...
    /**
     * /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     * методы ниже используются для создания миниатюр и кнопки удаления миниатюр, применение эффектов тени а также
     * переключение видимых синий линий
     * только createThumbnail вызывается в imageprocessor в методе putImagesAndButtonsOnTabPane,
     * остальные методы этого блока вызываеются внутри createThumbnail
     * /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     */
    ...
    public void handleThumbnailClick(Image img, ImageView thumbnailImageView) {
        ...
        ImageView previouslySelectedThumbnail = selectedThumbnailView;
    ...
    public Button createDeleteButton(Image img, Tab currentTab) {
        ...
        deleteButton.setOnAction(event -> {
            ...
            imageProcessor.putImagesAndButtonsOnTabPane(imageProcessor.getController().xRayImages, currentTab); // Обновляем отображение изображений
        });
    ...
    /**
     * /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     * setupZoom и setupImageDrag используются в imageProcessor классе в методе putImagesAndButtonsOnTabPane
     * /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    */
